...
Then we used [ploidyNGS_perChr.slurm.sh](https://github.com/Franck-Dumetz/Crithidia_bombi/blob/ashome/Genome_comparison/ploidyNGS_perChr.slurm.sh) to determine the allele frequency per chromosome <br >
