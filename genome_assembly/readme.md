...
## Canu to assemble
```
/usr/local/packages/canu-2.1.1/bin/canu -assemble -p Crithidia -genomeSize=32m -useGrid=false -pacbio-hifi /local/projects-t3/SerreDLab-3/fdumetz/Crithidia/Cbombi_hifi_filtered.fastq.gz
```

## Determining coverage
```
minimap2 -ax map-hifi /local/projects-t3/SerreDLab-3/fdumetz/Crithidia/canu/Crithidia.contigs.fasta /local/projects-t4/aberdeen2ro/SerreDLab-4/raw_reads/2024-08-22_Pacbio/Cbombi_WHA1_20240805/PACBIO_DATA/EDS10_20240819_R84050_PL14293-001_1-1-A01_bc2093-bc2093.hifi_reads.fastq.gz | samtools sort -o Cbombi_reads2canu.bam

samtools index Cbombi_reads2canu.bam

samtools depth Cbombi_reads2canu.bam > Cbombi_depth.txt
awk '{print $3}' Cbombi_depth.txt
```

## Finding telomeres
```
seqkit locate -i -p TTAGGG Crithidia.contigs.fasta > telomere_position.txt
```
