...
/usr/local/packages/busco-5.4.3/bin/busco -m genome -i CbWHA1_assembly.final.fasta --auto-lineage-euk -o busco --out_path /local/projects-t3/SerreDLab-3/fdumetz/Crithidia/hifi -f
